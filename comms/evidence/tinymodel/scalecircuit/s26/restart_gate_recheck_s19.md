...
|---|---|---|
| refs | PASS | 5/5 files resolve non-empty |
| leakage | PASS | eval slice 30 docs / 27 questions vs 2 train file(s): id overlap none, question overlap 0 |
| distribution | PASS | 0/20120 train questions (0.0%) share a content 3-gram with the eval questions (FAIL>2%, SUSPECT>0.5%) |
| stamp-order | PASS | 1/1 pins predate the result artifact |
