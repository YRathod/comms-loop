...
# tinymodel/scalecircuit s39 — slice v2 (n=400), the one run under key #8: claimed iterative + notes +0.038 with a 95% interval [+0.006, +0.071]: a real gain, decisively above zero, and NOT PASSED under the pinned band (mean < +0.05); prediction held
